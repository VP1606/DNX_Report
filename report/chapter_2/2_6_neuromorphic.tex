...
An \gls{snn}, by contrast, communicates exclusively via binary spikes; since a spike is either $0$ or $1$, the multiplication is eliminated entirely, reducing each synaptic event to a \gls{ac} operation at a cost of $E_{\text{AC}} = 0.9$\,pJ - a $5\times$ reduction in per-operation energy at the silicon level \cite{horowitz20141}.

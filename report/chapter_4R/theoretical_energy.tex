...
\hline
\textbf{Model} & \textbf{Dataset (Task)} & \textbf{\gls{map_50}} & \textbf{Params (M)} & \textbf{G-SOPs} & \textbf{Power (mJ)} & \textbf{mAP/mJ} \\
\hline

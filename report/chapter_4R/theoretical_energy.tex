...
deploying models such as \texttt{DetectorNX} on real neuromorphic hardware requires substantial development effort in its own right, and the power saving of $76.21\%$ on Loihi 2 is unlikely to be realised in the real-world due to unaccounted overheads.

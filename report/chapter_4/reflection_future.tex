...
Paired with the critical analysis, we propose potential ideas in tandem that can be investigated to resolve these impacts.
...
As established in early spiking vision literature, rate coding over discrete steps creates a $1/T$ ($10\%$) quantization error in the feature maps \cite{THORPE2001715}. 
...
This approach would natively interpret the temporal oscillation of the spiking backbone, smoothing the highly reactive event evidence into stable, monotonic predictions suitable for deployment in \gls{adas}-like systems.

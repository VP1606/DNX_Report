...
The first step of the \texttt{REPLICA} pipeline applies a series of signal-conditioning operations, lifted directly from the original \gls{etram} study since they were tuned to the characteristics of the dataset \cite{Verma_2024_CVPR}, and serving three complementary purposes.

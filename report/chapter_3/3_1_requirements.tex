...
These requirements formed the foundation for the three-generation evolution of the \texttt{DetectorNX-G3-SNN} architecture detailed in Section \ref{sec:snn_architecture}, and drove the rigorous benchmarking suite evaluated in Section ?? %\ref{sec:results_evaluation}%.

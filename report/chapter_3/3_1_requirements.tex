...
These requirements formed the foundation for the three-generation evolution of the \texttt{SNN\_MAX\_REPLICA\_SE} architecture detailed in Section \ref{sec:model_design}, and drove the rigorous benchmarking suite evaluated in Section \ref{sec:results_evaluation}.

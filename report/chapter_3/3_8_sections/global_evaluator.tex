...
Table \ref{tab:global_benchmark} summarizes the headline results for the G3 generation of the \texttt{DetectorNX} model architecture against its \gls{cnn} counterpart.

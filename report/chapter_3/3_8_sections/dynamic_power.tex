...
\hline
\textbf{Layer Name} & \textbf{CNN FLOPs (M)} & \textbf{SNN SOPs (M)} & \textbf{Sparsity ($\zeta$) (\%)} \\
\hline
...
\todo[inline]{Extend Derivation to go from FLOP/SOP instead of using measured values?}
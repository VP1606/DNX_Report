...
\begin{figure}[h]
    ...
    \caption{Quantisation Error Analysis (Accuracy vs. Object Size) of \gls{snn} (Blue) and \gls{cnn} (Orange).}
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Quantisation Error Analysis showing drop in \gls{snn} performance against \gls{cnn}.}

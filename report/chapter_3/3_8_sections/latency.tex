...
To simulate a real-world edge-deployment scenario, a batch size of one was utilized, ensuring that the throughput
...
The empirical results confirm the hardware-mismatch penalty hypothesized in Section \ref{subsec:exp_latency}: 

...
throughput, which cannot equally be judged against asynchronous spike-based execution. 
While Loihi benchmarks report up to $10\times$ lower latency over embedded 

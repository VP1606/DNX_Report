...
Table~\ref{tab:model_hyperparameters} consolidates the trained configuration.

\begin{table}[H]
\centering
\caption[Training configuration for \texttt{DetectorNX-G3-SNN}.]{Training configuration for \texttt{DetectorNX-G3-SNN}.}

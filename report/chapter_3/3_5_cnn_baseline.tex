...
The \texttt{DetectorNX-G3-CNN} baseline is an 11.73M-parameter \gls{cnn} designed to mirror the \gls{snn} architecture, satisfying the ``Architectural Parity'' functional requirement specified in Section~\ref{subsec:req_functional}. The only variable tested is the neural activation mechanism (event-driven binary spikes versus continuous-valued floats), making the comparison immune to criticisms of unmatched or unoptimised baselines.

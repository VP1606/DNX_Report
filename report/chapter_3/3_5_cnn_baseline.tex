...
If the corresponding SNN achieves 43\% \gls{iou}, the 5\% gap explicitly represents the ``quantisation cost'' of switching from 32-bit continuous floats to 1-bit binary spikes \cite{quantization_error_putra}. 

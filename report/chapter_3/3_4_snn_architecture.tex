...
In this \texttt{SNN\_MAX\_REPLICA\_SE} architecture, the bottleneck exists at the transition point between stages 2 and 3 of the backbone, and represents two things:
  ...
  \begin{enumerate}
      ...
      At this stage, the original $640 \times 360$ spatiotemporal input has been downsampled by a factor of 16x via the strided convolutions in the stem and early residual block, resulting in a highly compressed $22 \times 40$ feature map.

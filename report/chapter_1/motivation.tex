...
Beyond the generic scaling pressure noted in Section~\ref{sec:intro_overview}, \acrfullpl{cnn} suffer a paradigm-specific weakness. Their static, frame-based nature mandates billions of dense \gls{mac} operations per frame regardless of scene content, generating metabolic load and thermal throttling even on visually redundant or static scenes \cite{lin_adas_cnn_issues}.

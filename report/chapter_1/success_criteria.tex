...
\begin{enumerate}
    ...
    Both models must achieve a recall at $\mathrm{IoU}\ge0.5$ of $100\%$ on the validation set, confirming that the multi-box regression head reliably detects all ground-truth vehicles in the scene.
